...
public class Query03 {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        // 2) Baglanti olustur
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/batch59?serverTimezone=UTC", "root", "Yd12345.");
        ...
        ResultSet veri3 = st.executeQuery("select bolum_isim, personel_isim, maas from bolumler as B left join personel as p on B.bolum_id = P.bolum_id order by bolum_isim desc, P.maas");
        while (veri3.next()){
